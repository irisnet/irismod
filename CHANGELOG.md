...
* (modules/nft)  [\#243](https://github.com/irisnet/irismod/pull/243) The query `Owner` is renamed to `NFTsOfOwner`, of which the parameter `Owner` is mandatory and `DenomID` is optional
