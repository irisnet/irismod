...
func (m *GenesisState) GetPendingRandomRequests() map[string]Requests {
	if m != nil {
		return m.PendingRandomRequests
	}
	return nil
}
...
func (*Requests) Descriptor() ([]byte, []int) {
	return fileDescriptor_55381a259c753e1a, []int{1}
}
...
var fileDescriptor_55381a259c753e1a = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PendingRandomRequests) > 0 {
		for k := range m.PendingRandomRequests {
			v := m.PendingRandomRequests[k]
			baseI := i
			{
...
func (m *GenesisState) Size() (n int) {
	...
	_ = l
	if len(m.PendingRandomRequests) > 0 {
		for k, v := range m.PendingRandomRequests {
			_ = k
			_ = v
			l = v.Size()
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PendingRandomRequests", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PendingRandomRequests == nil {
				m.PendingRandomRequests = make(map[string]Requests)
			}
			var mapkey string
			mapvalue := &Requests{}
			for iNdEx < postIndex {
			...
			m.PendingRandomRequests[mapkey] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenesis(dAtA[iNdEx:])
