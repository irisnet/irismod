...
var (
	...
	poolAddrBTC = GetReservePoolAddr(denomLptBTC)
	poolAddrETH = GetReservePoolAddr(denomLptETH)
)
...
func TestMigrate(t *testing.T) {
	...
	err := Migrate(ctx, app.CoinswapKeeper, app.BankKeeper, app.AccountKeeper)
