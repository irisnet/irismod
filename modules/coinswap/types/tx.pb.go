...
type MsgAddLiquidity struct {
	...
	ExactStandardAmt cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=exact_standard_amt,json=exactStandardAmt,proto3,customtype=cosmossdk.io/math.Int" json:"exact_standard_amt"`
...
type MsgRemoveLiquidity struct {
	...
	MinToken          cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=min_token,json=minToken,proto3,customtype=cosmossdk.io/math.Int" json:"min_token"`
	MinStandardAmt    cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=min_standard_amt,json=minStandardAmt,proto3,customtype=cosmossdk.io/math.Int" json:"min_standard_amt"`
	Deadline          int64                 `protobuf:"varint,4,opt,name=deadline,proto3" json:"deadline,omitempty"`
	Sender            string                `protobuf:"bytes,5,opt,name=sender,proto3" json:"sender,omitempty"`
}
...
type MsgRemoveUnilateralLiquidity struct {
	...
	ExactLiquidity    cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=exact_liquidity,json=exactLiquidity,proto3,customtype=cosmossdk.io/math.Int" json:"exact_liquidity"`
	Deadline          int64                 `protobuf:"varint,4,opt,name=deadline,proto3" json:"deadline,omitempty"`
	Sender            string                `protobuf:"bytes,5,opt,name=sender,proto3" json:"sender,omitempty"`
}
...
var fileDescriptor_828eca8448acda28 = []byte{
	...
	,
}
