...
var (
	...
	ErrPoolExist          = sdkerrors.Register(ModuleName, 7, "the farm pool exist")
	ErrPoolNotFound       = sdkerrors.Register(ModuleName, 8, "the farm pool is not exist")
	ErrInvalidOperate     = sdkerrors.Register(ModuleName, 9, "invalid operate")
	ErrFarmerNotFound     = sdkerrors.Register(ModuleName, 10, "the farmer is not exist")
