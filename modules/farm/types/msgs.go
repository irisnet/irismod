...
func (msg MsgCreatePool) ValidateBasic() error {
	...
	if err := ValidateCoins(msg.RewardPerBlock, "RewardPerBlock"); err != nil {
		return err
	}
	...
	if err := ValidateCoins(msg.TotalReward, "TotalReward"); err != nil {
		return err
	}
...
func (msg MsgAdjustPool) ValidateBasic() error {
	...
	if msg.AdditionalReward != nil {
		if err := ValidateCoins(msg.AdditionalReward, "AdditionalReward"); err != nil {
			return err
		}
	}
...
func (msg MsgStake) ValidateBasic() error {
	...
	if err := ValidateCoins(sdk.NewCoins(msg.Amount), "Amount"); err != nil {
		return err
	}
	return ValidatePoolName(msg.PoolName)
}
