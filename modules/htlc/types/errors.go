...
var (
	...
	ErrInvalidSwapDirection        = sdkerrors.Register(ModuleName, 18, "invalid swap direction")
	ErrInsufficientAmount          = sdkerrors.Register(ModuleName, 19, "amount cannot cover the deputy fixed fee")
	ErrExceedsSupplyLimit          = sdkerrors.Register(ModuleName, 20, "asset supply over limit")
	ErrExceedsTimeBasedSupplyLimit = sdkerrors.Register(ModuleName, 21, "asset supply over limit for current time period")
	ErrInvalidCurrentSupply        = sdkerrors.Register(ModuleName, 22, "supply decrease puts current asset supply below 0")
	ErrInvalidIncomingSupply       = sdkerrors.Register(ModuleName, 23, "supply decrease puts incoming asset supply below 0")
	ErrInvalidOutgoingSupply       = sdkerrors.Register(ModuleName, 24, "supply decrease puts outgoing asset supply below 0")
	ErrExceedsAvailableSupply      = sdkerrors.Register(ModuleName, 25, "outgoing swap exceeds total available supply")
	ErrAssetSupplyNotFound         = sdkerrors.Register(ModuleName, 26, "asset supply not found in store")
)
