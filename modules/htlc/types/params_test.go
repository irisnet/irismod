...
func (suite *ParamsTestSuite) SetupTest() {
	...
	supply1 := types.SupplyLimit{
		Limit:          math.NewInt(10000000000000),
		TimeLimited:    false,
	...
	supply2 := types.SupplyLimit{
		Limit:          math.NewInt(10000000000000),
		TimeLimited:    true,
		TimeBasedLimit: math.NewInt(100000000000),
