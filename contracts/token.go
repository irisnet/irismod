...
func (_Token *TokenTransactor) Burn(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "burn", account, amount)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address account, uint256 amount) returns()
func (_Token *TokenSession) Burn(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Burn(&_Token.TransactOpts, account, amount)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address account, uint256 amount) returns()
func (_Token *TokenTransactorSession) Burn(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Burn(&_Token.TransactOpts, account, amount)
}
...
// SwapToNative is a paid mutator transaction binding the contract method 0x0bdf9c40.
//
// Solidity: function swapToNative(string to, uint256 amount, bool isERIS) returns()
func (_Token *TokenTransactor) SwapToNative(opts *bind.TransactOpts, to string, amount *big.Int, isERIS bool) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "swapToNative", to, amount, isERIS)
}

// SwapToNative is a paid mutator transaction binding the contract method 0x0bdf9c40.
//
// Solidity: function swapToNative(string to, uint256 amount, bool isERIS) returns()
func (_Token *TokenSession) SwapToNative(to string, amount *big.Int, isERIS bool) (*types.Transaction, error) {
	return _Token.Contract.SwapToNative(&_Token.TransactOpts, to, amount, isERIS)
}

// SwapToNative is a paid mutator transaction binding the contract method 0x0bdf9c40.
//
// Solidity: function swapToNative(string to, uint256 amount, bool isERIS) returns()
func (_Token *TokenTransactorSession) SwapToNative(to string, amount *big.Int, isERIS bool) (*types.Transaction, error) {
	return _Token.Contract.SwapToNative(&_Token.TransactOpts, to, amount, isERIS)
}
...
// TokenSwapToNativeIterator is returned from FilterSwapToNative and is used to iterate over the raw logs and unpacked data for SwapToNative events raised by the Token contract.
type TokenSwapToNativeIterator struct {
	Event *TokenSwapToNative // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenSwapToNativeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenSwapToNative)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenSwapToNativeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenSwapToNativeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenSwapToNative represents a SwapToNative event raised by the Token contract.
type TokenSwapToNative struct {
	To     string
	Amount *big.Int
	IsERIS bool
	Raw    types.Log // Blockchain specific contextual infos
...
// FilterSwapToNative is a free log retrieval operation binding the contract event 0xffb968192d84a77c5892772d5cd4388ee89fc501d4295b374b5b5c8f81f6a5d6.
//
// Solidity: event SwapToNative(string to, uint256 amount, bool isERIS)
func (_Token *TokenFilterer) FilterSwapToNative(opts *bind.FilterOpts) (*TokenSwapToNativeIterator, error) {

	logs, sub, err := _Token.contract.FilterLogs(opts, "SwapToNative")
	if err != nil {
		return nil, err
	}
	return &TokenSwapToNativeIterator{contract: _Token.contract, event: "SwapToNative", logs: logs, sub: sub}, nil
}

// WatchSwapToNative is a free log subscription operation binding the contract event 0xffb968192d84a77c5892772d5cd4388ee89fc501d4295b374b5b5c8f81f6a5d6.
//
// Solidity: event SwapToNative(string to, uint256 amount, bool isERIS)
func (_Token *TokenFilterer) WatchSwapToNative(opts *bind.WatchOpts, sink chan<- *TokenSwapToNative) (event.Subscription, error) {

	logs, sub, err := _Token.contract.WatchLogs(opts, "SwapToNative")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenSwapToNative)
				if err := _Token.contract.UnpackLog(event, "SwapToNative", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseSwapToNative is a log parse operation binding the contract event 0xffb968192d84a77c5892772d5cd4388ee89fc501d4295b374b5b5c8f81f6a5d6.
//
// Solidity: event SwapToNative(string to, uint256 amount, bool isERIS)
func (_Token *TokenFilterer) ParseSwapToNative(log types.Log) (*TokenSwapToNative, error) {
	event := new(TokenSwapToNative)
	if err := _Token.contract.UnpackLog(event, "SwapToNative", log); err != nil {
		return nil, err
	}
