...
var (
	...
	fd_MsgSwapCoinResponse_amount protoreflect.FieldDescriptor
)

func init() {
	file_irismod_coinswap_tx_proto_init()
	md_MsgSwapCoinResponse = File_irismod_coinswap_tx_proto.Messages().ByName("MsgSwapCoinResponse")
	fd_MsgSwapCoinResponse_amount = md_MsgSwapCoinResponse.Fields().ByName("amount")
}
...
func (x *fastReflection_MsgSwapCoinResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Amount != nil {
		...
		if !f(fd_MsgSwapCoinResponse_amount, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgSwapCoinResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "irismod.coinswap.MsgSwapCoinResponse.amount":
		return x.Amount != nil
	default:
		if fd.IsExtension() {
...
func (x *MsgSwapCoinResponse) GetAmount() *v1beta1.Coin {
	if x != nil {
		return x.Amount
	}
	return nil
...
var file_irismod_coinswap_tx_proto_rawDesc = []byte{
	...
	0x6e, 0x70, 0x75, 0x74, 0x73, 0x22, 0x4e, 0x0a, 0x13, 0x4d, 0x73, 0x67, 0x53, 0x77, 0x61, 0x70,
	0x43, 0x6f, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x06,
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x91, 0x01, 0x0a, 0x0f, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xfd, 0x04, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x5c, 0x0a, 0x0c,
	...
	0x6d, 0x6f, 0x64, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x73, 0x77, 0x61, 0x70, 0x2e, 0x4d, 0x73, 0x67,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0xb5, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x72, 0x69,
	0x73, 0x6d, 0x6f, 0x64, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x73, 0x77, 0x61, 0x70, 0x42, 0x07, 0x54,
	...
	0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x73, 0x77, 0x61, 0x70, 0xa2, 0x02, 0x03, 0x49, 0x43, 0x58, 0xaa,
	0x02, 0x10, 0x49, 0x72, 0x69, 0x73, 0x6d, 0x6f, 0x64, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x77,
	0x61, 0x70, 0xca, 0x02, 0x10, 0x49, 0x72, 0x69, 0x73, 0x6d, 0x6f, 0x64, 0x5c, 0x43, 0x6f, 0x69,
	0x6e, 0x73, 0x77, 0x61, 0x70, 0xe2, 0x02, 0x1c, 0x49, 0x72, 0x69, 0x73, 0x6d, 0x6f, 0x64, 0x5c,
	0x43, 0x6f, 0x69, 0x6e, 0x73, 0x77, 0x61, 0x70, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x11, 0x49, 0x72, 0x69, 0x73, 0x6d, 0x6f, 0x64, 0x3a, 0x3a,
	0x43, 0x6f, 0x69, 0x6e, 0x73, 0x77, 0x61, 0x70, 0xc8, 0xe1, 0x1e, 0x00, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_irismod_coinswap_tx_proto_depIdxs = []int32{
	...
	12, // 10: irismod.coinswap.MsgSwapCoinResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	15, // 11: irismod.coinswap.MsgUpdateParams.params:type_name -> irismod.coinswap.Params
	0,  // 12: irismod.coinswap.Msg.AddLiquidity:input_type -> irismod.coinswap.MsgAddLiquidity
	2,  // 13: irismod.coinswap.Msg.AddUnilateralLiquidity:input_type -> irismod.coinswap.MsgAddUnilateralLiquidity
	4,  // 14: irismod.coinswap.Msg.RemoveLiquidity:input_type -> irismod.coinswap.MsgRemoveLiquidity
	6,  // 15: irismod.coinswap.Msg.RemoveUnilateralLiquidity:input_type -> irismod.coinswap.MsgRemoveUnilateralLiquidity
	8,  // 16: irismod.coinswap.Msg.SwapCoin:input_type -> irismod.coinswap.MsgSwapOrder
	10, // 17: irismod.coinswap.Msg.UpdateParams:input_type -> irismod.coinswap.MsgUpdateParams
	1,  // 18: irismod.coinswap.Msg.AddLiquidity:output_type -> irismod.coinswap.MsgAddLiquidityResponse
	3,  // 19: irismod.coinswap.Msg.AddUnilateralLiquidity:output_type -> irismod.coinswap.MsgAddUnilateralLiquidityResponse
	5,  // 20: irismod.coinswap.Msg.RemoveLiquidity:output_type -> irismod.coinswap.MsgRemoveLiquidityResponse
	7,  // 21: irismod.coinswap.Msg.RemoveUnilateralLiquidity:output_type -> irismod.coinswap.MsgRemoveUnilateralLiquidityResponse
	9,  // 22: irismod.coinswap.Msg.SwapCoin:output_type -> irismod.coinswap.MsgSwapCoinResponse
	11, // 23: irismod.coinswap.Msg.UpdateParams:output_type -> irismod.coinswap.MsgUpdateParamsResponse
